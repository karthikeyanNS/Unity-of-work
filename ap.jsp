...
<html>
	...
	<div class="row flex r1">
		<div class="col-lg-6 c1">
			<h1 class="topic">Appliances</h1>
		</div>
		<div class="col-lg-6">
			<video width="500" height="500" autoplay loop muted>
            <source src="images/appliance/appliance.mp4" type="video/mp4">
            </video>
		</div>
	</div>
            <div class="innerhr1">
                <a href="#lp"><span>LapTop</span></a>
                <a href="#mw"><span>Micro-ove Work</span></a>
                <a href="#fw"><span>Fridge Work</span></a>
                <a href="#wm"><span>Washing-Machine Work</span></a>
                <a href="#wp"><span>Water-Purifier Work</span></a>
                <a href="#hw"><span>Water-Heater Work</span></a>
                <a href="#tv"><span>Tv Work</span></a>
                <a href="#ac"><span>Ac Work</span></a>
      ...
      try
        {
           ...
           PreparedStatement ps = con.prepareStatement("select * from appliance");
   ...
   %>
           <div class='row flex hr2'>
			...
			<div class="col-lg-6 d1">
                            <img id="repair" src="images/appliance/<%= rs.getString(7) %>">
