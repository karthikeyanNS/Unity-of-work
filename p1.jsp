...
<html>
	...
	<div class="row flex r1">
		<div class="col-lg-6 c1">
			<h1 class="topic">Home Painting</h1>
		</div>
		<div class="col-lg-6">
			<video width="500" height="500" autoplay loop muted>
            <source src="images/paint/paint.mp4" type="video/mp4">
            </video>
		</div>
	</div>
            <div class="innerhr1">
                <a href="#Fc"><span>Full-Home-Paint-Work</span></a>
                <a href="#mp"><span>Furniture Paint</span></a>
                <a href="#th"><span>Gate-Paint-Work</span></a>
            </div>
        </div> 
     <div class="container">
<%
      try
        {
           ...
           PreparedStatement ps = con.prepareStatement("select * from paint");
   ...
   %>
           <div class='row flex hr2'>
			...
			<div class="col-lg-6 d1">
                            <img id="repair" src="images/paint/<%= rs.getString(7) %>">
