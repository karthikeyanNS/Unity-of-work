...
<html>
	...
	<div class="row flex r1">
		<div class="col-lg-6 c1">
			<h1 class="topic">Salon For Men</h1>
		</div>
		<div class="col-lg-6">
			<video width="500" height="500" autoplay loop muted>
            <source src="images/men/men.mp4" type="video/mp4">
            </video>
		</div>
	</div>
            <div class="innerhr1">
      ...
      try
        {
           ...
           PreparedStatement ps = con.prepareStatement("select * from men");
   ...
   %>
           <div class='row flex hr2'>
			...
			<div class="col-lg-6 d1">
                            <img id="repair" src="images/men/<%= rs.getString(7) %>">
