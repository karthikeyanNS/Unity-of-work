...
<html>
	...
	<div class="row flex r1">
		<div class="col-lg-6 c1">
			<h1 class="topic">Plumber</h1>
		</div>
		<div class="col-lg-6">
			<video width="500" height="500" autoplay loop muted>
            <source src="images/plumber/Plumber.mp4" type="video/mp4">
            </video>
		</div>
	</div>
            <div class="innerhr1">
                <a href="#Tap"><span>Tap-Work</span></a>
                <a href="#Tiolet"><span>Tiolet-Work</span></a>
                <a href="#Tank"><span>Tank-Work</span></a>
      ...
      try
        {
           ...
           PreparedStatement ps = con.prepareStatement("select * from plumber");
   ...
   %>
           <div class='row flex hr2'>
			...
			<div class="col-lg-6 d1">
                            <img id="repair" src="images/plumber/<%= rs.getString(7) %>">
