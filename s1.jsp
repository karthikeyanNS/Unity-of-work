...
<html>
    <head>
        ...
        <title>Styling & Massage For Women</title>
        <link rel="stylesheet" type="text/css" href="uw.css">
    </head>
    <body>
	...
	<div class="row flex r1">
		<div class="col-lg-6 c1">
			<h1 class="topic">Styling & Massage</h1>
		</div>
		<div class="col-lg-6">
			<video width="500" height="500" autoplay loop muted>
            <source src="images/style/style.mp4" type="video/mp4">
            </video>
		</div>
	</div>
            <div class="innerhr1">
                <a href="#Fc"><span>Hair-Styling</span></a>
                <a href="#mp"><span>Hair-Coloring</span></a>
                <a href="#th"><span>Wedding-Makeup</span></a>
                <a href="#fcw"><span>Hair-Cuts & Spa</span></a>
            </div>
        </div> 
     <div class="container">
<%
      try
        {
           ...
           PreparedStatement ps = con.prepareStatement("select * from style");
   ...
   %>
           <div class='row flex hr2'>
			...
			<div class="col-lg-6 d1">
                            <img id="repair" src="images/style/<%= rs.getString(7) %>">
