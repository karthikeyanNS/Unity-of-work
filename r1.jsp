...
<html>
	...
	<div class="row flex r1">
		...
		<div class="col-lg-6">
            ...
            <source src="images/electrician/Electrician.mp4" type="video/mp4">
            </video>
		</div>
	</div>
            <div class="innerhr1">
                <a href="#switch"><span>Switch-Work</span></a>
                <a href="#light"><span>Light-Work</span></a>
                <a href="#inverter"><span>Inverter-Work</span></a>
                <a href="#fan"><span>Fan-Work</span></a>
                <a href="#other"><span>Others</span></a>
            </div>
        </div>
<div class="container">
<%
      try
        {
           ...
           PreparedStatement ps = con.prepareStatement("select * from electrician");
   ...
   %>
           <div class='row flex hr2'>
			...
			<div class="col-lg-6 d1">
                            <img id="repair" src="images/electrician/<%= rs.getString(7) %>">
