...
<html>
	...
	<div class="row flex r1">
		...
		<div class="col-lg-6">
            ...
            <source src="images/carpenter/Carpenter.mp4" type="video/mp4">
            </video>
		</div>
	</div>
            <div class="innerhr1">
                <a href="#Door"><span>Door-Work</span></a>
                <a href="#Wall"><span>Wall-Work</span></a>
                <a href="#Self"><span>Self-Work</span></a>
                <a href="#Furniture"><span>Furniture-Work</span></a>
            </div>
        </div>
<div class="container">
<%
      try
        {
           ...
           PreparedStatement ps = con.prepareStatement("select * from carpenter");
   ...
   %>
           <div class='row flex hr2'>
			...
			<div class="col-lg-6 d1">
                            <img id="repair" src="images/carpenter/<%= rs.getString(7) %>">
