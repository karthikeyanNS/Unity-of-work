...
<html>
	...
	<div class="row flex r1">
		<div class="col-lg-6 c1">
			<h1 class="topic">Hair-Skin-Nails</h1>
		</div>
		<div class="col-lg-6">
			<video width="500" height="500" autoplay loop muted>
            <source src="images/skn/skn.mp4" type="video/mp4">
            </video>
		</div>
	</div>
            <div class="innerhr1">
                <a href="#hc"><span>Hair-Cut</span></a>
                <a href="#fc"><span>Facial-Work</span></a>
                <a href="#ms"><span>Massage-Work</span></a>
                <a href="#rt"><span>Routine Work</span></a>
      ...
      try
        {
           ...
           PreparedStatement ps = con.prepareStatement("select * from skn");
   ...
   %>
           <div class='row flex hr2'>
			...
			<div class="col-lg-6 d1">
                            <img id="repair" src="images/skn/<%= rs.getString(7) %>">
